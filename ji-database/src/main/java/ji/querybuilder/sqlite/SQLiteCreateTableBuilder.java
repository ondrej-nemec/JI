...
public class SQLiteCreateTableBuilder extends QueryBuilderParent implements CreateTableBuilder {

	private boolean first = true;
	
	public SQLiteCreateTableBuilder(Connection connection, String table) {
