...
public class SQLiteSelectBuilder extends SelectWrapper<SelectBuilder> implements SelectBuilder {
	
	public SQLiteSelectBuilder(Connection connection, String... select) {
		super(connection);
		select(select);
	}
