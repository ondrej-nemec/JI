...
public class SQLiteQueryBuilder implements QueryBuilderFactory {
	...
	public Functions getSqlFunctions() {
		return new SQLiteFunctions();
	}

	@Override
	public DeleteBuilder delete(String table) {
		return new SQLiteDeleteBuilder(connection, table);
	}

	@Override
	public InsertBuilder insert(String table) {
		return new SQLiteInsertBuilder(connection, table);
	}

	@Override
	public UpdateBuilder update(String table) {
		return new SQLiteUpdateBuilder(connection, table);
	}

	@Override
	public SelectBuilder select(String... select) {
		return new SQLiteSelectBuilder(connection, select);
	}
	...
	public CreateTableBuilder createTable(String name) {
		return new SQLiteCreateTableBuilder(connection, name);
	}

	@Override
	public AlterTableBuilder alterTable(String name) {
		return new SQLiteAlterTableBuilder(connection, name);
	}
	...
	public CreateViewBuilder createView(String name) {
		return new SQLiteCreateViewBuilder(connection, name, false);
	}

	@Override
	public CreateViewBuilder alterView(String name) {
		return new SQLiteCreateViewBuilder(connection, name, true);
	}
